...
import { createPost, uploadFile } from "@/lib/blog-api";
        ...
        <div className="space-y-6 pt-4">
            ...
            <div className="space-y-4 border-l-2 border-border pl-4 py-2 opacity-50 focus-within:opacity-100 transition-opacity">
                <input 
                    ...
                    className="w-full bg-transparent font-mono text-sm text-muted-foreground focus:text-foreground focus:outline-none"
                />
                <TextareaAutosize 
